...
public class Robot extends TimedRobot {
  ...
  public void teleopPeriodic() {
    ...
    //arcade
    r_motor_1.set(r_joystick.getY()-r_joystick.getX());
    l_motor_1.set(l_joystick.getY()+l_joystick.getX());
